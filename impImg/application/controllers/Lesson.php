<?php
	...
	{
		$this->data['breadcrumb']['heading'] = 'Lesson';  
		$this->data['breadcrumb']['route'] = array(array('title'=>'Aabhyas','path'=>'lesson'),'Lesson');  
	...
	public function get_show_data($item_id = NULL)
	{
 	...
 	{
 		$this->data['breadcrumb']['heading'] = 'Add Lesson';
		$this->data['breadcrumb']['route'] = array(array('title'=>'Aabhyas','path'=>'lesson'),array('title'=>'Lesson','path'=>'Lesson'),'Add');
		...
		else
		{
			if($check)
			{
				if(!is_null($id))
				{
					$this->data['breadcrumb']['heading'] = 'Edit Lesson';  
					$this->data['breadcrumb']['route'] = array(array('title'=>'Aabhyas','path'=>'Lesson'),array('title'=>'Lesson','path'=>'Lesson'),'Edit');  
					$this->data['What'] = 'Edit';
