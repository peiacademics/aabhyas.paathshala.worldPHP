<div class="ibox">
  <div class="ibox-title">
      <h5><?php echo ucfirst($this->lang_library->translate('Add Lesson')); ?></h5>
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo base_url('Lesson/add'); ?>" method="post" id="bank_add">
                        <input type="hidden" name="ID" value="<?php echo @$View['ID'];?>">
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="Lesson Number" name="lesson_no" value="<?php echo @$View['lesson_no']; ?>">
                              </div>
                                <span id="bank_name"></span>
                          </div>
                         <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="Lesson Name" name="name" value="<?php echo @$View['name']; ?>" required>
                              </div>
                                <span id="bank_name"></span>
                          </div>
