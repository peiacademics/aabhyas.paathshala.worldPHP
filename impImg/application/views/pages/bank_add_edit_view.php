                        ...
                        <input type="hidden" name="ID" value="<?php echo @$View['ID'];?>">
                         <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input type="text" class="datepicker form-control" name="account_opening_date" placeholder=" Opening Date" value="<?php echo $this->date_library->db2date(@$View['account_opening_date'],$this->date_library->get_date_format());?>">
                              </div>
