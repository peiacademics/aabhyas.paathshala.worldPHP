  ...
  <div class="modal-dialog modal-lg m-lgg">
    <div class="modal-content animated flipInX">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Test Attendance</h4>
      </div>
...
function test_attendace(id)
{
  ...
  $.ajax({
    ...
    success:function(response)
    {
      var data = '<table class="table table-responsive table-striped table-bordered" width="100%"><thead><tr><th class="text-center">Sr. No.</th><th class="text-center">Name</th><th class="text-center">Attendance</th><th class="text-center">Marks / Out Of</th><th class="text-center">Latency Reason</th><th class="text-center">Remark</th></tr></thead><tbody>';
      if(response != '')
      {
        response = JSON.parse(response);
        var i = 1;
...
function commun(id)
{
  $.ajax({
    ...
    method:'POST',
    data:{ID:id,rec_id:'CMSSK10000006',tbl:'TE'},
    datatype:'JSON',
    success:function(response){
      response = JSON.parse(response);
