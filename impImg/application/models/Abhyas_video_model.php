<?php
	class Abhyas_video_model extends CI_Model
	{
		...
		public function upload_video()
	    {
	       	if(!empty($_FILES))
	    	{
	    		if(($_FILES['file']['type'] == "video/mp4") || ($_FILES['file']['type'] == "video/avi") || ($_FILES['file']['type'] == "video/mov") || ($_FILES['file']['type'] == "video/3gp") || ($_FILES['file']['type'] == "video/mpeg") || ($_FILES['file']['type'] == "video/flv") || ($_FILES['file']['type'] == "video/x-ms-wmv"))
	    		{
					$new_name = str_replace(" ", "-", time().$_FILES["file"]['name']);
			        $config['upload_path']          = './abhyas_video_upload/';
			        $config['allowed_types']        = '*';
			        $config['max_size']             = '1000000';//1000000
