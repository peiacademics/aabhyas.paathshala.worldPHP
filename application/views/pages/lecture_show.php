        ...
        eventRender: function(event, element) {
             ...
             else
             {
              ...
              element.find('.fc-title').html('<button id="'+event.id+'" class="btn btn-circle" type="button" style="background:'+bClass+'"><i class="fa '+bfClass+'"></i></button><b>'+event.title+'</b>');
                if (event.imageurl) {
                    element.find("div.fc-content").prepend("<img src='" + IMAGE_PATH+event.imageurl +"' width='30' class='crlwName'>");
                }
        }
    });
...
$("#add_Classesed").on('click',function(e){
  e.preventDefault();
    ...
    $('.modal-content').prepend('<div id="Login_screen"><img src="'+IMAGE_PATH+'img/loader1.gif"></div>');
