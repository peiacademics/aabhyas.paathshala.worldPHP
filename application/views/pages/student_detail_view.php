                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div>
                            <div class="ibox-content no-padding border-left-right">
                                <img alt="image" class="img-responsive" src="<?php echo IMAGE_PATH.$path; ?>">
                            </div>
                            <div class="ibox-content profile-content responsive">
                                ...
                                <?php if(($this->session_library->get_session_data('Login_as') == 'DSSK10000001') || ($this->session_library->get_session_data('Login_as') == 'DSSK10000002') || ($this->session_library->get_session_data('Login_as') == 'DSSK10000013')) { ?>
                                <div class="user-button">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" class="btn btn-default btn-sm btn-block"><i class="fa fa-archive"></i> Archive</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="user-button">
                                                      ...
                                                      <div class="file">
                                                          <a href="#">
                                                              ...
                                                              <?php  if (!empty($img)) {
                                                               ?>
                                                                <div class="image">
                                                                    <img alt="image" class="img-responsive" src="<?php echo IMAGE_PATH.$img;?>">
                                                                </div>
                                                             <?php } else { ?>
                                                      ...
                                                      <div class="file">
                                                          <a href="#">
                                                              ...
                                                              <?php  if ($ext==='jpg' || $ext==='png' || $ext==='JPG' || $ext==='PNG') {
                                                               ?>
                                                                <div class="image">
                                                                    <img alt="image" class="img-responsive" src="<?php echo IMAGE_PATH.$value['path'];?>">
                                                                </div>
                                                             <?php } else { ?>
                                                                <div class="icon"><i class="img-responsive fa fa-film"></i></div>
                                                              <?php } ?>
...
<?php if ($this->session_library->get_session_data('Login_as')==='DSSK10000011') { ?>
  localStorage.setItem('token','<?php echo $DETAIL['studentDetail'][0]['token'];?>');
  localStorage.setItem('studebt','<?php echo $DETAIL['studentDetail'][0]['ID'];?>');
<?php } ?>
