 <div class="page-content">
      ...
      <div class="row">
        <div class="pull-right">
         <a href="<?php echo base_url('Lesson/add'); ?>"><button typer="button" class="btn btn-w-m btn-primary dim btn-outline"><i class="fa fa-plus"></i> Add Lesson</button></a>
        </div>
        ...
        <div class="ibox">
          ...
          <!-- <div class="ibox-title">
              ...
              <h5><?php echo ucfirst($this->lang_library->translate('Lesson')); ?></h5>
