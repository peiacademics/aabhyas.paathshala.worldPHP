      ...
      if(response != '')
      {
        ...
        if(response.present != null)
        {
          $.each(response.present, function(key,value){
            data += '<div class="feed-element"><a href="'+base_url+'student/view/'+value.ID+'" class="pull-left"><img alt="image" class="img-circle" src="'+IMAGE_PATH+value.path+'"></a><div class="media-body "><strong>'+value.name+'</strong></div></div>';
          });
        }
        else
        {
        ...
        if(response.absent != null)
        {
          $.each(response.absent, function(key,value){
            data += '<div class="feed-element"><a href="#'+value.ID+'" class="pull-left"><img alt="image" class="img-circle" src="'+IMAGE_PATH+value.path+'"></a><div class="media-body "><strong>'+value.name+'</strong></div></div>';
          });
        }
        else
        {
