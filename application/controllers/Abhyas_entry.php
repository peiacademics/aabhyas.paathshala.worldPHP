<?php
	class Abhyas_entry extends CI_Controller {
	...
	public function __construct()
	{
		...
		if($this->login_model->check_login())
		{
			...
			$this->load->model('abhyas_entry_model');
	...
	{
		$this->data['breadcrumb']['heading'] = 'Abhyas';  
		$this->data['breadcrumb']['route'] = array(array('title'=>'Dashboard','path'=>'dashboard'),'Abhyas');
		$this->load->view('includes/header',$this->data);
		$this->load->view('pages/abhyas_entry_view',$this->data);
		$this->load->view('includes/footer',$this->data);
	}

	public function get_menu_list()
	{
		echo json_encode($this->abhyas_entry_model->get_menu_list());
	}
